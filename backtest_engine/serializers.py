        ...
        if obj.additional_stats and isinstance(obj.additional_stats, dict):
            ...
            if long_stats:
                ...
                result['long'] = {
                    ...
                    'avg_intra_trade_drawdown': round(float(long_stats.get('avg_intra_trade_drawdown', 0)), 2) if long_stats.get('avg_intra_trade_drawdown') is not None else None,
                    'worst_intra_trade_drawdown': round(float(long_stats.get('worst_intra_trade_drawdown', 0)), 2) if long_stats.get('worst_intra_trade_drawdown') is not None else None,
            ...
            result['short'] = {
                ...
                'avg_intra_trade_drawdown': round(float(short_stats.get('avg_intra_trade_drawdown', 0)), 2) if (isinstance(short_stats, dict) and short_stats.get('avg_intra_trade_drawdown') is not None) else None,
                'worst_intra_trade_drawdown': round(float(short_stats.get('worst_intra_trade_drawdown', 0)), 2) if (isinstance(short_stats, dict) and short_stats.get('worst_intra_trade_drawdown') is not None) else None,
